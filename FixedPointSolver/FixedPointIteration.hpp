 ...
 *
 */
  template <class Traits, template <class> class Accelerator=NoAccelerator>
  class FixedPointIteration
  {
  public:
    //! The type of the argument and return value
    using ArgumentType = typename Traits::ArgumentType;
    using AcceleratorType = Accelerator<Traits>;
    using IterationFunction = typename Traits::IterationFunction;
